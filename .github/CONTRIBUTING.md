# Contributing to numpy-client

This document is a guide to contributing to numpy-client
...
## Building numpy-client from source

You'll need to build numpy-client locally in order to start editing code.

To install numpy-client from source, clone the GitHub
...
To contribute to numpy-client, send us pull requests.
For those new to contributing, check out GitHub's
[guide](https://help.github.com/articles/using-pull-requests/).

Once you've made your pull request, a member of the numpy-client
...
If you'd like to add a new feature to numpy-client, please do propose your
...
- Read the numpy-client source and enhance the documentation,
  or address TODOs
- Browse the [issue tracker](https://github.com/tschm/numpy-client/issues),
...
numpy-client tests live in the directory `tests`,
